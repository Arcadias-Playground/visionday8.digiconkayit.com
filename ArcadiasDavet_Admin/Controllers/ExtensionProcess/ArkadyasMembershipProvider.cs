...
namespace VeritabaniIslemMerkezi
{
    public class ArkadyasMembershipProvider : MembershipProvider
    {
        ...
        {
            VTIslem = new VTOperatorleri("SELECT COUNT(*) FROM KullaniciTablosu WHERE KullaniciAdi=@KullaniciAdi AND Sifre=@Sifre");
            VTIslem.AddWithValue("KullaniciAdi", username);
    ...
    public class ArkadyasRoleProvider : RoleProvider
    {
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            try
            {
                VTIslem = new VTOperatorleri("SELECT 'Arkadyas' AS KullaniciTipi FROM KullaniciTablosu WHERE KullaniciAdi=@KullaniciAdi");
                VTIslem.AddWithValue("KullaniciAdi", username);
