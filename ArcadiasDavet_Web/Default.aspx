<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ArcadiasDavet_Web.Default" %>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12">
                        <div class="card auth_form">
                            <div class="header">
                                <asp:Image ID="ImgLogo" runat="server" ImageUrl="~/Gorseller/logo.png" style="width:85%; border:1px solid black;"/>
                                <h5>Giriş</h5>
                            </div>
                            <div class="body">
