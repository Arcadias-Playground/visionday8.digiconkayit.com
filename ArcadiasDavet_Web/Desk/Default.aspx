<%@ Page Title="" Language="C#" MasterPageFile="~/Desk/Desk.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ArcadiasDavet_Web.Desk.Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Desk_head" runat="server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="Deskk_Icerik" runat="server">
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="PnlArama" runat="server" DefaultButton="lnkbtnAra">
                                <table class="AlseinTable mb-3">
                                    <tr>
                                        <td class="d-none">&nbsp;</td>
                                        <td style="width: 150px;">Aranacak Kelime</td>
                                        <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div>
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server" Visible='<%#!string.IsNullOrEmpty(Eval("Telefon").ToString()) %>' Font-Size="10px">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Desk_AltSayfa" runat="server">
